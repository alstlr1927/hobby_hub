                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: (status.hasFocus && widget.title.isNotEmpty)
                            ? ''
                            : widget.hintText,
                        hintStyle: HobbyStyle.caption(
                            color: TextFieldColor.textField_hint_text,
                            weight: FontWeight.w400),
                        isCollapsed: isCollapse,
                        filled: true,
                        fillColor: HobbyStyle.gray040,
                        hintMaxLines: 2,
                        disabledBorder: OutlineInputBorder(
                          borderRadius: borderRadius,
                          borderSide: const BorderSide(
                              color: HobbyStyle.gray040, width: 1),
                        ),
                        enabledBorder: OutlineInputBorder(
                          borderRadius: borderRadius,
                          borderSide: BorderSide(
                            color: HobbyStyle.gray040,
                            width: 1,
                          ),
                        ),
                    ...
                    if (!status.hasError) {
                      return Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: Text('', style: HobbyStyle.caption()),
                            ),
