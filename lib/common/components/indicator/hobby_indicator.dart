...
/// [HobbyIndicator] 다크모드와 상관없이 기본 인디케이터에 색상을 사용할 수 있음
/// 보통 Progress처리에 주로 사용
class HobbyIndicator extends StatefulWidget {
  ...
  @override
  _HobbyIndicatorState createState() => _HobbyIndicatorState();
}

class _HobbyIndicatorState extends State<HobbyIndicator>
  ...
  @override
  void didUpdateWidget(HobbyIndicator oldWidget) {
